...
"""Depth, Ego-Motion and Region Deformer Networks. Based on struct2depth"""
...
# have a mean of 1.
DISP_SCALING = 10  # for outdoor dataset
MIN_DISP = 0.01  # for outdoor dataset

WEIGHT_DECAY_KEY = 'WEIGHT_DECAY'


def egomotion_net(image_stack, disp_bottleneck_stack, joint_encoder, seq_length,
                  weight_reg, same_trans_rot_scaling):
    ...
    Args:
      ...
      same_trans_rot_scaling: Whether to use the same scaling factor for translation
          and rotation
    ...
    with tf.variable_scope('pose_exp_net') as sc:
        ...
        with slim.arg_scope([slim.conv2d, slim.conv2d_transpose],
            ...
            with tf.variable_scope('pose'):
                ...
                # Note: bug here!
                if same_trans_rot_scaling:  # original code
                    # Actually translation and rotation are scaled by same constant SCALE_TRANSLATION
